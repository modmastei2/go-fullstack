    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {/* Auto Lock Info */}
                <div className="bg-gradient-to-br from-blue-500 to-blue-600 dark:from-blue-700 dark:to-blue-800 rounded-lg shadow-md p-6 text-white">
                ...
                {/* Session Timeout */}
                <div className="bg-gradient-to-br from-yellow-500 to-yellow-600 dark:from-yellow-600 dark:to-yellow-700 rounded-lg shadow-md p-6 text-white">
                    <div className="flex items-center mb-4">
                        <svg className="w-8 h-8 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {/* Security */}
                <div className="bg-gradient-to-br from-green-500 to-green-600 dark:from-green-700 dark:to-green-800 rounded-lg shadow-md p-6 text-white">
                    <div className="flex items-center mb-4">
                        <svg className="w-8 h-8 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white dark:bg-slate-900 rounded-lg shadow-md p-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="p-4 bg-blue-50 dark:bg-gray-700 rounded-lg border border-blue-200 dark:border-blue-600">
                    ...
                    <div className="p-4 bg-purple-50 dark:bg-gray-700 rounded-lg border border-purple-200 dark:border-purple-600">
                        <h4 className="font-semibold text-purple-800 dark:text-purple-200 mb-2">Security Features</h4>
